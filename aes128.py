...
class AES128:
    def __init__(self, secret_key: str):
        self.n_k = len(secret_key)
        if self.n_k not in (16,24,32):
    ...
    def decrypt(self, ciphertext: str):
        ...
        self.__add_round_key(self.cipher_state_matrix, self.round_keys[40:])
    ...
    def encrypt(self, plaintext: str):
        self.n_b = len(plaintext)
        
        if self.n_b not in (16,24,32):
